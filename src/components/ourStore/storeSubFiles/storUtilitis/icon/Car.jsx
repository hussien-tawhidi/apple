  ...
  return (
    <div className="storeCard">
      <svg
        ...
        viewBox="0 0 49 56"
        width="49"
        className="as-svgicon as-svgicon-boxtruck as-svgicon-elevated car"
        aria-hidden="true"
        role="img"
      >
      ...
      <div className="cardTexts">
        <p className="car">
          enjoy <span>tow hour delivery</span> from an apple store ,
          <span>free delivery</span> or <span>easy pickUp</span>
        </p>
      </div>
    </div>
  );
